  ...
  return (
    <Layout>
      ...
      <div className="max-w-sm mx-auto justify-center items-center">
       ...
       <span className="text-2xl text-black font-bold m-5 p-5">ZUMJI POINTS: 700</span>
       </Block>
...
<div className="w-full max-w-sm  border rounded-lg shadow bg-gray-800 border-gray-700">
    ...
    <div className="px-5 pb-5 ">
        <a href="#">
            <h5 className="text-xl font-semibold tracking-tight p-5 text-white"> Advertise Products Here</h5>
        </a>
        <div className="flex items-center mt-2.5 mb-5">
            ...
            <span className="bg-blue-100 text-xs font-semibold px-2.5 py-0.5 roundedbg-blue-200 text-blue-800 ms-3">5.0</span>
        </div>
        <div className="flex items-center justify-between">
            <span className="text-3xl font-bold text-gray-900 dark:text-white">$599</span>
            <a href="#" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Go To</a>
        </div>
    </div>
</div>
